...
# count_operator and count_operand are to check if the polish_expression is valid after performing the moves
# count_operator should be lesser than count_operand even after we switch
